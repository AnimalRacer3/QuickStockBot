...
class TestDailyPLColors:
    def test_profit_day_is_green(self, db: sqlite3.Connection) -> None:
    ...
    def test_loss_day_is_red(self, db: sqlite3.Connection) -> None:
    ...
    def test_flat_day_is_blue(self, db: sqlite3.Connection) -> None:
    ...
    def test_ran_but_no_trades_is_blue(self, db: sqlite3.Connection) -> None:
    ...
    def test_non_run_day_omitted(self, db: sqlite3.Connection) -> None:
    ...
    def test_empty_date_range(self, db: sqlite3.Connection) -> None:
    ...
    def test_cumulative_net_pl(self, db: sqlite3.Connection) -> None:
    ...
    def test_ran_field_is_always_true(self, db: sqlite3.Connection) -> None:
